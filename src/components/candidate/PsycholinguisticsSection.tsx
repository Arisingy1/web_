...
const HIDDEN_MARKERS = new Set(['dominance_interruptions']);
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800 md:p-8">
      ...
      <div className="mb-8 grid grid-cols-1 gap-3 md:grid-cols-2">
        {data.tone.tone_audio.audio_markers
          .filter((marker) => !HIDDEN_MARKERS.has(marker.marker))
          .map((marker, idx) => (
